...
CalculatorGoalPublisher::CalculatorGoalPublisher(unsigned int time_interval_s)
    : Node("calculator_goal_publisher"), time_interval_s_(time_interval_s) {
  ...
  timer_ = this->create_wall_timer(
      ...
      std::bind(&CalculatorGoalPublisher::calculator_goal_publisher, this));
}

void CalculatorGoalPublisher::calculator_goal_publisher() {
